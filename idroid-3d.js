...
const container = document.getElementById('div3d')
if (!container) throw new Error('#div3d not found')
...
// Controles Orbit — desabilitado auto-rotate para o modelo ficar parado
...
// Neutral lighting — bright, clean, no red tint
...
loader.load(
  'src/assets/images/icons/3d_icon/idroid.glb',
  (gltf) => {
...
function onScroll() {
  const section = document.querySelector('.idroid-3d-section')
  if (!section) return
